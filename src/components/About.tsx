    ...
    >
      <div className="mx-auto grid max-w-6xl items-center gap-16 px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div>
          ...
          <p
            data-reveal
            className="mt-6 text-base font-light leading-relaxed text-ink/80"
          >
          ...
          <p
            data-reveal
            className="mt-4 text-base font-light leading-relaxed text-ink/80"
          >
          ...
          <div data-reveal className="mt-10 border-l-2 border-gold pl-6">
            <p className="font-display text-xl italic text-charcoal">
              &ldquo;We care for every resident the way we would care for our
              own mother.&rdquo;
            </p>
