  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap
        ...
        .from('[data-hero-line]', { scaleX: 0, duration: 0.9, ease: 'power2.inOut' }, '-=0.6')
        .from('[data-hero-subtext]', { y: 28, opacity: 0, duration: 0.9 }, '-=0.55')
        ...
        .from('[data-hero-badge]', { y: 20, opacity: 0, duration: 0.7 }, '-=0.5')
        .from('[data-hero-trust]', { y: 16, opacity: 0, duration: 0.8 }, '-=0.45')
    }, sectionRef)
    return () => ctx.revert()
  }, [])
      ...
      <div className="relative mx-auto w-full max-w-6xl px-6 pb-16 pt-28 sm:pt-32 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          <div>
            ...
            <div data-hero-line className="my-8 h-px w-24 origin-left bg-gold" aria-hidden />
            ...
            >
              A sanctuary of comfort and professional wellness for your loved ones
              in Lagos — where every day is met with warmth, expertise, and the
          ...
          <div data-hero-image className="relative mx-auto w-full max-w-md lg:max-w-none">
            ...
            >
              <p className="font-display text-3xl font-semibold text-charcoal">12+</p>
